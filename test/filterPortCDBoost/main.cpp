...
int main(int argc, char ** argv) {
  ...
  auto FilterPortIncrement = make_atomic_ptr<filter<Time,Message>, string>(string("incr"));

  shared_ptr<flattened_coupled<Time, Message>> TOP(new flattened_coupled<Time, Message>(
  {input_test_generator, FilterPortIncrement}, 
  {}, 
  {{input_test_generator, FilterPortIncrement}}, 
  {FilterPortIncrement}
  ));  
    ...
    ofstream out_data("filterPort_test_output.txt");   
